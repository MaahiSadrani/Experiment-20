...
##  Aim
To perform COVID-19 data analysis using Python libraries such as Pandas, NumPy, and Plotly by cleaning real-world data,
generating insights, comparing country-wise and state-wise statistics, and visualizing cases using interactive maps.
##  Theory:
...
Real-world datasets often contain missing values, unnecessary columns, incorrect data types, and large volumes of records that must be processed before analysis.
COVID-19 data analysis became one of the most important real-world applications of data science.
By analyzing confirmed cases, deaths, recoveries, and active cases, governments and researchers can understand the spread of disease and take informed decisions.
...
<img width="1808" height="543" alt="image" src="https://github.com/user-attachments/assets/2c47b287-8b67-4067-bfe6-b4e0100fe050" />
<img width="1808" height="542" alt="image (1)" src="https://github.com/user-attachments/assets/ba8c6c37-b89f-430e-a83d-b1d722d30b33" />
<img width="1807" height="592" alt="image (2)" src="https://github.com/user-attachments/assets/f08c55d8-e5a2-44f8-bb5a-f28dc2e9606b" />
